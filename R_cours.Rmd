...
## Quarto: The Next Generation {#quarto}

- Quarto is the multi-language, next-generation version of R Markdown.
- It allows you to create high-quality articles, reports, presentations (like this one!), and websites.
- **Key advantage**: It is independent of R, meaning it works seamlessly with Python, Julia, and Observable JS as well.
...
**Anatomy of a Quarto Chunk**

Quarto introduces the "hashpipe" `#|` for options, which is cleaner than the old RMarkdown header.

```{r}
#| label: fig-plot
#| fig-cap: "A beautiful ggplot2 figure"
#| warning: false
