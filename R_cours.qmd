...
format:
  revealjs:
    ...
    footer: "Doctoral Course - R & Data Science"
    logo: img/R_logo.png
execute:
  echo: true
  warning: false
...
#| include: false
library(here)
source(here("script_source.R"), local=knitr::knit_global())
```
...
![](img/data_non_tidy.png){fig-align="center" width="400px"}
...
- Validation Framework (`pointblank`): A formal way to document and automate data quality checks.
