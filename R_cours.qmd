...
- create a new Quarto notebook called "basics"
- install the packages `tidyverse` and `questionr`
- in the first cell of the quarto document, load `tidyverse` and `questionr`
...
### Customizing for Publication {#gtsummary_pub}
